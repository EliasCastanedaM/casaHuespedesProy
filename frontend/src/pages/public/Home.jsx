...
import { getRoomAvailability, getRooms } from "../../services/api";
import "./Home.css";
...
const extraServices = [
  {
    ...
    alt: "Cocina disponible en Casa HuÃ©spedes Pimentel",
    description:
      "Espacio disponible para que los huÃ©spedes puedan preparar sus alimentos, previa coordinaciÃ³n.",
  },
  {
    ...
    alt: "Servicio de lavado y planchado de Casa HuÃ©spedes Pimentel",
    description:
      "Servicio adicional de lavado y planchado disponible previa coordinaciÃ³n con el hospedaje.",
  },
  {
    ...
    alt: "Ingreso y orientaciÃ³n de estacionamiento en Casa HuÃ©spedes Pimentel",
    description:
      "OrientaciÃ³n sobre movilidad local, servicios de taxi y estacionamiento cercano al hospedaje.",
  },
];
...
const galleryImages = [
  {
    ...
    alt: "Fachada de Casa HuÃ©spedes Pimentel",
  },
  {
    src: "/img/galeria/galeria-2.jpg",
    alt: "HabitaciÃ³n de Casa HuÃ©spedes Pimentel",
  },
  {
    src: "/img/galeria/galeria-3.jpg",
    alt: "Espacios comunes de Casa HuÃ©spedes Pimentel",
  },
  {
    src: "/img/galeria/galeria-4.jpg",
    alt: "Vista desde Casa HuÃ©spedes Pimentel",
  },
];
...
const ROOM_DETAILS = {
  ...
  305: {
    ...
    description:
      "HabitaciÃ³n matrimonial ubicada en el tercer piso, con una cama de dos plazas y capacidad para 2 personas.",
    locationDetail: "Ubicada en el tercer piso.",
    amenities: ["BaÃ±o privado", "Smart TV", "Ventilador", "Velador", "Ropero"],
  },
  405: {
...
function extractRoomNumber(room) {
  ...
  const match = String(room?.name || "").match(
    /(?:#|hab(?:itaci[oÃ³]n)?\.?\s*)?(101|201|202|203|205|301|302|303|304|305|405|407|505)\b/i,
  );
...
function getRoomDetails(room) {
  ...
  return {
    ...
    bedType:
      catalogDetails.bedType || room?.bed_type || "DistribuciÃ³n por confirmar",
    capacity: Number(catalogDetails.capacity || room?.capacity || 1),
    locationDetail:
      catalogDetails.locationDetail ||
      `Ubicada en ${catalogDetails.floorLabel || "Pimentel"}.`,
...
export default function Home() {
  ...
  function handleContinueToBooking(event) {
    ...
    if (!bookingForm.room_id) {
      setBookingError(
        "Selecciona una habitaciÃ³n para continuar con la reserva.",
      );
      return;
    }
  ...
  return (
    <main className="home-page">
        ...
        <div className="hotel-hero-image">
          ...
          <div className="home-section hotel-hero-content">
            <div className="hotel-hero-text">
              <p className="hotel-hero-kicker">Descanso Â· Playa Â· Pimentel</p>

              <h1 className="hotel-hero-main-title">
                Un refugio cerca al mar:
                <span>Casa HuÃ©spedes Pimentel</span>
              </h1>

              <p>
                Habitaciones de acuerdo a tus necesidades, atenciÃ³n familiar y
                una estadÃ­a tranquila para disfrutar el balneario de Pimentel.
              </p>
      ...
      <StoryVideoSection
        ...
        description="Disfruta de la tranquilidad de Pimentel, un destino ideal para caminar junto al mar, visitar su emblemÃ¡tico muelle y descubrir restaurantes donde podrÃ¡s disfrutar lo mejor de la gastronomÃ­a peruana.
        Pimentel es un encantador balneario ubicado en la costa norte del PerÃº, en el departamento de Lambayeque. Destaca por sus hermosas playas, su tradicional muelle y su ambiente tranquilo, ideal para descansar y disfrutar de la riqueza cultural y gastronÃ³mica de la regiÃ³n.
        "
        ...
        <div className="hotel-availability-grid">
                  ...
                  {availableRooms.map((room) => {
                    ...
                    return (
                      <option key={room.id} value={room.id}>
                        Hab. {details.roomNumber} â€” {details.roomType} â€”{" "}
                        {details.floorLabel} â€” Hasta {details.capacity}{" "}
                        persona(s)
                      </option>
                    );
                  })}
          ...
          <aside className="hotel-side-card">
            ...
            <p className="hotel-side-description">
              Revisa la ubicaciÃ³n, capacidad y disponibilidad de cada
              habitaciÃ³n.
            </p>
  ...
  return (
    ...
    >
      <div className="mx-auto mb-10 max-w-3xl text-center lg:mb-14">
        <p className="hotel-eyebrow">UbicaciÃ³n</p>

        <h2 className="hotel-title hotel-story-title mt-3">
          Â¿CÃ³mo llegar a Casa de HuÃ©spedes Pimentel?
        </h2>

        <p className="mx-auto mt-4 max-w-2xl text-base leading-7 text-[#6f6257]">
          Conoce nuestra ubicaciÃ³n y planifica tu llegada de manera sencilla.
        ...
        <article className="overflow-hidden rounded-[28px] border border-[#eadfce] bg-white shadow-[0_18px_50px_rgba(43,33,24,0.10)]">
          <div className="aspect-video overflow-hidden bg-[#eee7dc]">
            <iframe
              ...
              title="UbicaciÃ³n de Casa de HuÃ©spedes Pimentel en Google Maps"
              loading="lazy"
              allowFullScreen
          ...
          <div className="flex flex-col gap-5 p-6 sm:flex-row sm:items-center sm:justify-between lg:p-7">
            <div>
              ...
              <p className="mt-2 leading-7 text-[#6f6257]">
                Consulta la ruta mÃ¡s conveniente desde donde te encuentres.
              </p>
            </div>
...
function RoomBox({ room, selectedRoomId, hasDateSelected, onSelectRoom }) {
  const details = getRoomDetails(room);
  const roomStatus = normalizeRoomStatus(room, hasDateSelected);
  ...
  return (
    ...
    >
      <strong>
        Hab. {details.roomNumber} Â· {details.roomType}
      </strong>
...
function SocialDock() {
  ...
  const asuntoCorreo = encodeURIComponent(
    "Consulta sobre Casa de HuÃ©spedes Pimentel",
  );
